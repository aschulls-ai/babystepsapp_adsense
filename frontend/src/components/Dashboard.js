...
const Dashboard = ({ currentBaby, onAddBaby }) => {
  ...
  return (
    <div className="container mx-auto px-4 py-6 max-w-6xl">
      {/* AdSense Demo Notice */}
      <div className="bg-blue-50 dark:bg-blue-900/30 border-l-4 border-blue-400 dark:border-blue-500 p-4 rounded-r-lg mb-8">
        <div className="flex items-center">
          ...
          <div className="ml-3">
            <p className="text-sm text-blue-700 dark:text-blue-200">
              <strong>Demo Version:</strong> This is a fully functional demo of Baby Steps, a comprehensive parenting app for tracking baby activities, milestones, and getting AI-powered guidance on nutrition and safety.
            </p>
          </div>
        </div>
      </div>
